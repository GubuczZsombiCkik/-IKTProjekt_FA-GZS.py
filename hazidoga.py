...
while menuv:  
    ...
    if (valasztas == '1'):
        ...
        poziin = input(colored("Add meg a módosítani vagy törölni kívánt elem pozícióját (0-tól kezdve): ", "light_green"))

        if (poziin == "" or not poziin.isnumeric()):
            print(colored("\nÉrvénytelen pozíció! Csak számot adjon meg.", "red"))
        else:
            pozi = int(poziin)
            if (0 <= pozi < len(mlist)):
                ...
                print(colored("\nÉrvénytelen pozíció!", "red"))

    elif (valasztas == '6'):
        print(colored("Kilépés a programból.", "green"))
        menuv = False  
